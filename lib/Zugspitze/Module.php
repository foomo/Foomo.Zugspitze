...
class Module extends ModuleBase {
	...
	public static function getResources()
	{
		return array(
			...
			\Foomo\Modules\Resource\Fs::getVarResource(\Foomo\Modules\Resource\Fs::TYPE_FOLDER, 'logs' . DIRECTORY_SEPARATOR . self::NAME),
	...
	public static function getTmpDir($className=null)
	{
		...
		if (!\is_null($className)) {
			$filename .= DIRECTORY_SEPARATOR . \str_replace('\\', '/', $className);
		} else {
			$filename .= DIRECTORY_SEPARATOR . self::NAME;
		}
	 ...
	 * @return string
	 */
	public static function getLogDir($className=null)
	{
		$filename = 'logs';
		if (!\is_null($className)) {
			$filename .= DIRECTORY_SEPARATOR . \str_replace('\\', '/', $className);
	 ...
	 * @return string
	 */
	public static function getVarDir($className=null)
	{
		$filename = 'modules';
		if (!\is_null($className)) {
			$filename .= DIRECTORY_SEPARATOR . \str_replace('\\', '/', $className);
